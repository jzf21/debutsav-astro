  ...
  return (
    <div className="bg-red relative bottom-0 text-white flex pt-2  flex-col w-full justify-center items-center gap-6">
      ...
      <div className="flex flex-row justify-center items-center">
        ...
        <a
          className="mx-2"
          href="https://matrix.to/#/#debutsavkochi:poddery.com"
          target="_blank"
        >
          <svg
            version="1.0"
            ...
            height="30"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 670.000000 766.000000"
            preserveAspectRatio="xMidYMid meet"
          >
            <g
              transform="translate(0.000000,766.000000) scale(0.100000,-0.100000)"
              fill="#fdd5df"
              stroke="#fdd5df"
            >
              <path
                d="M10 3835 l0 -3825 365 0 365 0 0 85 0 85 -265 0 -265 0 0 3649 0
3648 68 6 c37 4 154 7 260 7 l192 0 0 85 0 85 -360 0 -360 0 0 -3825z"
                stroke="#fdd5df"
              />
              <path
                d="M5950 7575 l0 -85 260 0 260 0 0 -3650 0 -3650 -108 0 c-60 0 -177
-3 -260 -7 l-152 -6 0 -84 0 -83 365 0 365 0 0 3825 0 3825 -365 0 -365 0 0
-85z"
                stroke="#fdd5df"
              />
              <path
                d="M2617 5230 c-234 -40 -450 -176 -624 -395 l-32 -40 -1 188 0 187
...
-154 214 -108 109 -241 172 -429 205 -89 16 -312 18 -394 5z"
                stroke="#fdd5df"
              />
            </g>
          </svg>
